...
func TestMake(t *testing.T) {
	...
	tests = []Test{
		...
		{Script: `make([]int64, -1)`, RunError: fmt.Errorf("make slice len must not be negative")},
		{Script: `make([]int64, 1, -1)`, RunError: fmt.Errorf("make slice cap must not be negative")},
		{Script: `make(chan int64, -1)`, RunError: fmt.Errorf("make chan buffer size must not be negative")},
