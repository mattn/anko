...
%token<tok> IDENT NUMBER STRING ARRAY VARARG FUNC RETURN VAR THROW IF ELSE FOR IN EQEQ NEQ GE LE OROR ANDAND NEW TRUE FALSE NIL IFINVALID MODULE TRY CATCH FINALLY PLUSEQ MINUSEQ MULEQ DIVEQ ANDEQ OREQ BREAK CONTINUE PLUSPLUS MINUSMINUS POW SHIFTLEFT SHIFTRIGHT SWITCH CASE DEFAULT GO CHAN MAKE OPCHAN TYPE LEN DELETE
...
expr :
	...
	| expr IFINVALID expr
	{
		$$ = &ast.IfInvalidOpExpr{Expr: $1, Lhs: $1, Rhs: $3}
		$$.SetPosition($1.Position())
	}
	| expr '.' IDENT
	{
